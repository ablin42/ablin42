	...
	return (
		...
		function (e, E) {
									...
									(function () {
										...
										for (var o = "", r = 0; r < yn(qt).length; r++) {
											...
											E.anchors.length && (i = E.anchors[r]),
												(o +=
													'<li><a href="#' + i + '"><span class="fp-sr-only">' + ye(r, "Section") + "</span><span></span></a>");
			...
			function oe(e) {
				e
					? ((function () {
							...
							var n =
									"onwheel" in jt.createElement("div") ? "wheel" : void 0 !== jt.onmousewheel ? "mousewheel" : "DOMMouseScroll",
								o = !!R && { passive: !1 };
				...
				e
					? (oe(!0),
					  (function () {
							if (o || l) {
								E.autoScrolling &&
									(L.removeEventListener(I.touchmove, Te, { passive: !1 }), L.addEventListener(I.touchmove, Te, { passive: !1 }));
				...
				"touchend" === t &&
					...
					("mouseenter" !== t || W) &&
						(E.normalScrollElements.split(",").forEach(function (e) {
							if (!o) {
								var t = qn(i, e),
									n = Wn(i, e);
								(t || n) &&
									(h.shared.isNormalScrollElement || (ie(!1), r && E.scrollOverflowHandler.setIscroll(i, !1)),
						...
						!o &&
							...
							(ie(!0), r && E.scrollOverflowHandler.setIscroll(i, !0), (h.shared.isNormalScrollElement = !1)));
			}
			function we() {
				var e = xn(),
					t = An();
						...
						E.slidesNavigation &&
							(function (e, t) {
								...
								for (var o = 0; o < t; o++) {
									var r = yn(ln, e)[o];
									jn(
										Gn('<li><a href="#"><span class="fp-sr-only">' + ye(o, "Slide", r) + "</span><span></span></a></li>"),
										yn("ul", n)[0]
									);
								}
			...
			function Le() {
				...
				if (!T && (!E.autoScrolling || E.scrollBar)) {
					...
					if (
						...
						(n = yn(Qt)[0].offsetTop),
						(o = n + xn()),
						("up" != t ? n <= Un() : o >= Un() + xn()) && (Ln(yn(Qt)[0], _t) || (Nn(yn(Qt)[0], _t), zn(Xn(yn(Qt)[0]), _t))),
						!Ln((e = f[s]), Xt))
					) {
						F = !0;
						var v,
			...
			function Pe(e) {
				var t = {};
				return (
					E.autoScrolling && !E.scrollBar ? ((t.options = -e), (t.element = yn(Dt)[0])) : ((t.options = e), (t.element = zt)), t
				);
			}
			function De(e) {
				var t;
			...
			function dt(e, t) {
				...
				(n = e),
					...
					E.navigation &&
						null != yn(nn)[0] &&
						(zn(yn(Kt, yn(nn)[0]), Xt), Nn(o ? yn('a[href="#' + o + '"]', yn(nn)[0]) : yn("a", yn("li", yn(nn)[0])[r]), Xt));
			}
			function vt(e) {
				var t = In(yn(Qt)[0], qt),
					n = In(e, qt);
