...
!(function (t) {
	...
	function i(t, e) {
		...
		return (
			t.baseUrl + "/releases/" + ("latest" === t.version ? "latest" : "v".concat(t.version)) + "/" + c + "/" + o + r + "." + i
		);
	}
	function c(t, e) {
		var n = e || ["fa"],
	...
	(j.prototype = {
		...
		then: function (t, e) {
			...
			return (
				(!e && !t) || this._handled || ((this._handled = !0), "rejected" === this._state && f && h(O, this)),
				"fulfilled" === this._state || "rejected" === this._state ? h(m, n) : this._then.push(n),
				n.then
			);
		},
		catch: function (t) {
